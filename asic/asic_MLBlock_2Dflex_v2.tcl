...
set myFiles [list MLBlock_2Dflex_v2.sv  MAC_unit_v2.sv  stream_mem.sv  mult_flex.sv  state_machine.sv  shifter.sv  stream_flex_v2.sv  accumulator_v2.sv];
# name of top level module
set basename MLBlock_2Dflex_v2;
