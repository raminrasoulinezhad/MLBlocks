...
set myFiles [list ../verilog/accumulator.v ../verilog/mult_flex.v ../verilog/state_machine.v ../verilog/stream_mem.v ../verilog/pe.v ../verilog/MLBlock.v ../verilog/shifter.v ../verilog/stream_flex.v];
# name of top level module
set basename MLBlock;
